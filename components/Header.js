    ...
    return (
        <div className="shadow-sm border-b bg-white sticky top-0 z-50">
            <div className="flex justify-between max-w-6xl mx-5 lg:mx-auto">
                ...
                {/* middle side search input feild */}
                    ...
                    {session ? (
                        <>
                            <div className="relative navBtn">
                                ...
                                <div className="absolute -top-1 -right-2 w-5 h-5 text-xs bg-red-500 rounded-full flex items-center justify-center animate-pulse text-white">3</div>
